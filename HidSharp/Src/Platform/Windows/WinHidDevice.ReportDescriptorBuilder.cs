...
namespace HidSharp.Platform.Windows
{
    partial class WinHidDevice
    {
        sealed class ReportDescriptorBuilder
        {
            ...
            {
                if (_globals.TryGetValue(globalItemTag, out uint oldDataValue) && oldDataValue == dataValue) { return; }
            ...
            {
                if (_globals.TryGetValue(globalItemTag, out uint oldDataValue) && oldDataValue == (uint)dataValue) { return; }
